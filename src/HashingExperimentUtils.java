    ...
    public static void main(String[] args) {
        ...
        if (input == 1) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                for (int j = 0; j < 30; j++) {
                    ...
                    Pair<Double, Double> pa = HashingExperimentUtils.measureOperationsProbing(a[i]);
        ...
        if (input == 2) {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                for (int j = 0; j < 30; j++) {
                    System.out.println("check #" + (j + 1));
                    Pair<Double, Double> pa = HashingExperimentUtils.measureOperationsChained(a[i]);
                    averageInsertion += pa.first();
                    averageSearch += pa.second();
                }
                insertionsTimes[i] = averageInsertion / 30;
        ...
        if (input == 3) {
            ...
            for (int j = 0; j < 10; j++) {
                System.out.println("check #" + (j + 1));
                Pair<Double, Double> pa = HashingExperimentUtils.measureLongOperations();
                averageInsertion += pa.first();
                averageSearch += pa.second();
            }
            ...
            for (int j = 0; j < 10; j++) {
                System.out.println("check #" + (j + 1));
                Pair<Double, Double> pa = HashingExperimentUtils.measureStringOperations();
                averageInsertion += pa.first();
                averageSearch += pa.second();
            }
